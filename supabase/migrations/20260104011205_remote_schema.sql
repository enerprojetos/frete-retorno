...
ALTER TYPE "public"."freight_status" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."freight" (
    ...
    "status" "public"."freight_status" DEFAULT 'OPEN'::"public"."freight_status" NOT NULL,
    "pickup_label" "text" NOT NULL,
    "pickup_geom" "public"."geometry"(Point,4326) NOT NULL,
    "dropoff_label" "text" NOT NULL,
    "dropoff_geom" "public"."geometry"(Point,4326) NOT NULL,
    "pickup_radius_m" integer DEFAULT 0 NOT NULL,
    "dropoff_radius_m" integer DEFAULT 0 NOT NULL,
    "notes" "text"
);
...
CREATE OR REPLACE FUNCTION "public"."create_freight"("p_shipper_id" "text", "p_pickup_label" "text", "p_pickup_lng" double precision, "p_pickup_lat" double precision, "p_dropoff_label" "text", "p_dropoff_lng" double precision, "p_dropoff_lat" double precision, "p_pickup_radius_m" integer DEFAULT 0, "p_dropoff_radius_m" integer DEFAULT 0, "p_notes" "text" DEFAULT NULL::"text") RETURNS "public"."freight"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
declare
  v_row public.freight;
begin
  insert into public.freight (
    shipper_id, pickup_label, pickup_geom, dropoff_label, dropoff_geom,
    pickup_radius_m, dropoff_radius_m, notes
  )
  values (
    p_shipper_id,
    p_pickup_label,
    (format('SRID=4326;POINT(%s %s)', p_pickup_lng, p_pickup_lat))::geometry,
    p_dropoff_label,
    (format('SRID=4326;POINT(%s %s)', p_dropoff_lng, p_dropoff_lat))::geometry,
    greatest(p_pickup_radius_m,0),
    greatest(p_dropoff_radius_m,0),
    p_notes
  )
...
ALTER FUNCTION "public"."create_freight"("p_shipper_id" "text", "p_pickup_label" "text", "p_pickup_lng" double precision, "p_pickup_lat" double precision, "p_dropoff_label" "text", "p_dropoff_lng" double precision, "p_dropoff_lat" double precision, "p_pickup_radius_m" integer, "p_dropoff_radius_m" integer, "p_notes" "text") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."trip" (
    ...
    "status" "public"."trip_status" DEFAULT 'OPEN'::"public"."trip_status" NOT NULL,
    "origin_label" "text" NOT NULL,
    "origin_geom" "public"."geometry"(Point,4326) NOT NULL,
    "destination_label" "text" NOT NULL,
    "destination_geom" "public"."geometry"(Point,4326) NOT NULL,
    "corridor_radius_m" integer DEFAULT 50000 NOT NULL,
    "profile" "text" DEFAULT 'driving-car'::"text" NOT NULL,
    "route_geom" "public"."geometry"(LineString,4326) NOT NULL,
...
CREATE OR REPLACE FUNCTION "public"."create_trip"("p_driver_id" "text", "p_origin_label" "text", "p_origin_lng" double precision, "p_origin_lat" double precision, "p_destination_label" "text", "p_destination_lng" double precision, "p_destination_lat" double precision, "p_corridor_radius_m" integer, "p_profile" "text", "p_route_ewkt" "text", "p_route_distance_m" integer, "p_route_duration_s" integer) RETURNS "public"."trip"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
declare
  v_row public.trip;
begin
  insert into public.trip (
    driver_id,
    origin_label, origin_geom,
    destination_label, destination_geom,
    corridor_radius_m,
    profile,
    route_geom,
  ...
  values (
    p_driver_id,
    p_origin_label,
    (format('SRID=4326;POINT(%s %s)', p_origin_lng, p_origin_lat))::geometry,
    p_destination_label,
    (format('SRID=4326;POINT(%s %s)', p_destination_lng, p_destination_lat))::geometry,
    greatest(p_corridor_radius_m, 0),
    coalesce(nullif(p_profile,''),'driving-car'),
    p_route_ewkt::geometry,
    p_route_distance_m,
    p_route_duration_s
  )
  returning * into v_row;
...
ALTER FUNCTION "public"."create_trip"("p_driver_id" "text", "p_origin_label" "text", "p_origin_lng" double precision, "p_origin_lat" double precision, "p_destination_label" "text", "p_destination_lng" double precision, "p_destination_lat" double precision, "p_corridor_radius_m" integer, "p_profile" "text", "p_route_ewkt" "text", "p_route_distance_m" integer, "p_route_duration_s" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."match_freights_for_trip"("p_trip_id" "uuid", "p_limit" integer DEFAULT 50) RETURNS TABLE("freight_id" "uuid", "pickup_dist_m" double precision, "dropoff_dist_m" double precision, "pickup_pos" double precision, "dropoff_pos" double precision, "score" double precision)
    LANGUAGE "sql" STABLE
    AS $$
  with t as (
    select *
  ...
  candidates as (
    select
      f.id as freight_id,
      -- distâncias em metros (cast geometry->geography)
      st_distance(f.pickup_geom::geography, (select route_geom::geography from t)) as pickup_dist_m,
      st_distance(f.dropoff_geom::geography, (select route_geom::geography from t)) as dropoff_dist_m,
      -- posição ao longo da linha (0..1) (precisa de geometry)
      st_linelocatepoint((select route_geom from t), f.pickup_geom) as pickup_pos,
      st_linelocatepoint((select route_geom from t), f.dropoff_geom) as dropoff_pos
    from public.freight f
    where f.status = 'OPEN'
      and st_dwithin(f.pickup_geom::geography, (select route_geom::geography from t), (select corridor_radius_m from t))
      and st_dwithin(f.dropoff_geom::geography, (select route_geom::geography from t), (select corridor_radius_m from t))
  )
  select
    freight_id,
    pickup_dist_m,
    ...
    pickup_pos,
    dropoff_pos,
    (pickup_dist_m + dropoff_dist_m) as score
  from candidates
  where pickup_pos < dropoff_pos
  order by score asc
  limit greatest(p_limit, 1);
$$;


ALTER FUNCTION "public"."match_freights_for_trip"("p_trip_id" "uuid", "p_limit" integer) OWNER TO "postgres";
...
CREATE INDEX "ix_freight_dropoff_gist" ON "public"."freight" USING "gist" ("dropoff_geom");



CREATE INDEX "ix_freight_pickup_gist" ON "public"."freight" USING "gist" ("pickup_geom");



CREATE INDEX "ix_trip_route_gist" ON "public"."trip" USING "gist" ("route_geom");
...
GRANT ALL ON TABLE "public"."freight" TO "anon";
GRANT ALL ON TABLE "public"."freight" TO "authenticated";
GRANT ALL ON TABLE "public"."freight" TO "service_role";



GRANT ALL ON FUNCTION "public"."create_freight"("p_shipper_id" "text", "p_pickup_label" "text", "p_pickup_lng" double precision, "p_pickup_lat" double precision, "p_dropoff_label" "text", "p_dropoff_lng" double precision, "p_dropoff_lat" double precision, "p_pickup_radius_m" integer, "p_dropoff_radius_m" integer, "p_notes" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."create_freight"("p_shipper_id" "text", "p_pickup_label" "text", "p_pickup_lng" double precision, "p_pickup_lat" double precision, "p_dropoff_label" "text", "p_dropoff_lng" double precision, "p_dropoff_lat" double precision, "p_pickup_radius_m" integer, "p_dropoff_radius_m" integer, "p_notes" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_freight"("p_shipper_id" "text", "p_pickup_label" "text", "p_pickup_lng" double precision, "p_pickup_lat" double precision, "p_dropoff_label" "text", "p_dropoff_lng" double precision, "p_dropoff_lat" double precision, "p_pickup_radius_m" integer, "p_dropoff_radius_m" integer, "p_notes" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."create_trip"("p_driver_id" "text", "p_origin_label" "text", "p_origin_lng" double precision, "p_origin_lat" double precision, "p_destination_label" "text", "p_destination_lng" double precision, "p_destination_lat" double precision, "p_corridor_radius_m" integer, "p_profile" "text", "p_route_ewkt" "text", "p_route_distance_m" integer, "p_route_duration_s" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."create_trip"("p_driver_id" "text", "p_origin_label" "text", "p_origin_lng" double precision, "p_origin_lat" double precision, "p_destination_label" "text", "p_destination_lng" double precision, "p_destination_lat" double precision, "p_corridor_radius_m" integer, "p_profile" "text", "p_route_ewkt" "text", "p_route_distance_m" integer, "p_route_duration_s" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_trip"("p_driver_id" "text", "p_origin_label" "text", "p_origin_lng" double precision, "p_origin_lat" double precision, "p_destination_label" "text", "p_destination_lng" double precision, "p_destination_lat" double precision, "p_corridor_radius_m" integer, "p_profile" "text", "p_route_ewkt" "text", "p_route_distance_m" integer, "p_route_duration_s" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."match_freights_for_trip"("p_trip_id" "uuid", "p_limit" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."match_freights_for_trip"("p_trip_id" "uuid", "p_limit" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."match_freights_for_trip"("p_trip_id" "uuid", "p_limit" integer) TO "service_role";
